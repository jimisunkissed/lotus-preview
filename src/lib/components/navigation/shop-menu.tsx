...
export function ShopMenu(): React.ReactNode {
  ...
  return (
    <>
      <div className="absolute z-50 flex left-6 sm:left-10 top-[35px] sm:top-[50px]">
        <Button variant="ghost" className="group flex gap-3.5 p-0 hover:bg-transparent" onClick={() => setOpenShop(!openShop)}>
          ...
          <div
            className={cn(
              'hidden sm:flex text-[15px] items-center gap-2 text-black group-hover:text-neutral-500 transition-all duration-300',
